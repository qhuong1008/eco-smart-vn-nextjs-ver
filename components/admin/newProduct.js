...
const NewProduct = ({ setOpenModal, getProducts, brands }) => {
  ...
  const menuItems = [
    { name: "Vietnamese", filterName: "vi" },
    { name: "English", filterName: "en" },
  ];
  console.log("menuItems:", menuItems);

  const [selected, setSelected] = useState("Vietnamese");
  const handleSelected = (e) => {
    ...
    let filterName = filterType[0].filterName.toString();
    if (filterName == "vi") {
      setSelected("Vietnamese");
    } else {
      setSelected("English");
    }
  };
    ...
    <>
      <div className="relative p-6 flex-auto">
        <div className="flex items-center">
          <div className="mr-5">Choose language:</div>
          <Dropdown>
            <Dropdown.Button color="success" flat>
              {selected}
            </Dropdown.Button>
            <Dropdown.Menu
            ...
            >
              {(item) => (
                <Dropdown.Item key={item.name} color="success">
                  {item.name}
                </Dropdown.Item>
              )}
            </Dropdown.Menu>
        ...
        <div className="rounded-lg shadow-xl bg-gray-50">
          ...
          <div>
            <input
              ...
              className="appearance-none rounded-lg border w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline"
              id="name"
              type="text"
          ...
          <div style={{ marginTop: "20px" }}>
            ...
            <select
              ...
              onClick={(e) => {
                ...
                setEmail(brands[e.target.options.selectedIndex].email);
              }}
        ...
        <div className="flex text-red-500 font-bold items-center justify-center">
          {message}
        </div>
      </div>
      {confirmModal ? (
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Do you want to add the new product?
                      </p>
                    </div>
                  </div>
                </div>
